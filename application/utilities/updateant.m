...
ant.tx.xyz_m = [ant.tx.xy,app.TransmitterZmEditField.Value*ones(ant.tx.numTx,1)];
ant.rx.xyz_m = [ant.rx.xy,app.ReceiverZmEditField.Value*ones(ant.rx.numRx,1)];
...
ant.vx.xyz_m = reshape([ant.vx.xy,app.TransmitterZmEditField.Value*ones(ant.vx.numVx,1)],ant.vx.numVx,1,3);
